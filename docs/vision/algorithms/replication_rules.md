...
Original path in that PR: algorithms/replication_rules.md
...
> **⚠ Pre-pivot archive — salvaged verbatim from stale PR #17 (`algorithms/replication_rules.md`, 2025-09-20).** Inspiration only: this describes the abandoned pre-Medusa `fractal_tree` vision, **not** current Medusa architecture, and nothing here is validated or active. Provenance + classification: [vision README](../README.md).
