<!--
SALVAGED ARCHIVE — pre-pivot vision/theory. NOT active architecture, NOT current, NOT validated.
Source: stale PR #17 (branch docs/research-and-design @ 33449a7, 2025-09-20).
Original path in that PR: docs/DESIGN_PHILOSOPHY.md
Classification: pre-pivot inspiration only (predates the Feb-2026 pivot to the Medusa CA engine).
Content below is verbatim from the PR; only this banner was prepended. See README.md for full provenance.
-->

> **⚠ Pre-pivot archive — salvaged verbatim from stale PR #17 (`docs/DESIGN_PHILOSOPHY.md`, 2025-09-20).** Inspiration only: this describes the abandoned pre-Medusa `fractal_tree` vision, **not** current Medusa architecture, and nothing here is validated or active. Provenance + classification: [vision README](README.md).
...
## 🧬 BEAM: Biological Evolution Algorithm Modeling
...
## 🌐 Fractal Architecture Philosophy
