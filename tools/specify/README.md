...
```bash
# Set your Specify API credentials
export SPECIFY_API_TOKEN="your-api-token-here"
export SPECIFY_REPOSITORY_ID="your-repo-id-here"
...
node scripts/fetch-tokens.js      # Step 1: Fetch
